...
func parallelBase() *charts.Parallel {
	...
	parallel.AddSeries("Arrah", generateParallelData(parallelDataBJ))
	return parallel
}
...
func parallelMulti() *charts.Parallel {
	...
	parallel.AddSeries("Arrah", generateParallelData(parallelDataBJ)).
		AddSeries("Patna", generateParallelData(parallelDataGZ)).
		AddSeries("Gaya", generateParallelData(parallelDataSH))
	return parallel
}
