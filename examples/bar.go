...
func barTitle() *charts.Bar {
	...
	bar.SetGlobalOptions(
		charts.WithTitleOpts(opts.Title{
			...
			Subtitle: "Bhojpur Charts is an awesome chart library",
			Link:     "https://github.com/bhojpur/charts",
			Right:    "40%",
		}),
...
func barXYFormatter() *charts.Bar {
	bar := charts.NewBar()
	bar.SetGlobalOptions(
		charts.WithTitleOpts(opts.Title{Title: "Customized the x-axis/y-axis formatter"}),
		charts.WithXAxisOpts(opts.XAxis{
...
func barReverse() *charts.Bar {
	...
	bar.SetGlobalOptions(
		charts.WithTitleOpts(opts.Title{
			Title: "Reverse x-axis and y-axis",
		}),
	)
