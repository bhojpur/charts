...
import (
	...
	"github.com/bhojpur/charts/pkg/render"
	tpls "github.com/bhojpur/charts/pkg/templates"
)

// copy from bhojpur/charts/pkg/templates/header.go
...
func (r *myOwnRender) Render(w io.Writer) error {
	...
	contents := []string{HeaderTpl, tpls.BaseTpl, tpls.ChartTpl, tpls.FooterTpl}
