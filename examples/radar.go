...
func radarBase() *charts.Radar {
	...
	radar.AddSeries("Arrah", generateRadarItems(radarDataBJ))
	return radar
}
...
func radarLegendMulti() *charts.Radar {
	...
	radar.AddSeries("Arrah", generateRadarItems(radarDataBJ), charts.WithItemStyleOpts(opts.ItemStyle{Color: "#F9713C"})).
		AddSeries("Patna", generateRadarItems(radarDataGZ), charts.WithItemStyleOpts(opts.ItemStyle{Color: "#B3E4A1"})).
		AddSeries("Gaya", generateRadarItems(radarDataSH), charts.WithItemStyleOpts(opts.ItemStyle{Color: "rgb(238, 197, 102)"})).
		SetSeriesOptions(
			charts.WithLineStyleOpts(opts.LineStyle{
				Width:   1,
				Opacity: 0.5,
